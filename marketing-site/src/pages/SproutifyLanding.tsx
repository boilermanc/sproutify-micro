    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans selection:bg-emerald-500 selection:text-white overflow-hidden">
      ...
      <section className="relative pt-32 pb-20 px-6 max-w-7xl mx-auto flex flex-col items-center text-center">
        ...
        >
          ...
          <span className="text-emerald-400">Microgreen Farmers</span>
        </motion.h1>
        ...
        >
          From seeding to sales, Sproutify Micro manages your trays, recipes, and tasks automatically. Stop guessing and start scaling.
        </motion.p>
          ...
          {!submitted ? (
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <div className="flex gap-2">
                ...
                >
                  {isSubmitting ? '...' : 'Join'} <ChevronRight size={18} />
                </button>
              </div>
              <div style={{ display: turnstileEnabled ? 'block' : 'none' }} className="flex justify-center">
            ...
            <div className="bg-emerald-500/20 border border-emerald-500/30 text-emerald-300 px-6 py-3 rounded-lg flex items-center justify-center gap-2">
              <CheckCircle2 size={20} /> Thanks! You're on the list.
            </div>
          )}
      ...
      <section className="py-20 bg-slate-900/50 border-y border-white/5">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">Streamline Your Grow</h2>
          ...
          >
            ...
            {[
              ...
              <motion.div key={idx} variants={fadeInUp} className="relative flex flex-col items-center text-center z-10">
                <div className="w-24 h-24 rounded-2xl bg-slate-800 border border-white/10 flex items-center justify-center mb-6 shadow-xl shadow-black/50">
          ...
          <div className="flex flex-col md:flex-row items-center gap-16">
            ...
            <div className="flex-1 order-2 md:order-1">
              ...
              <h2 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
                ...
                Your 24/7 Head Grower.
              </h2>
              <p className="text-slate-400 text-lg mb-8 leading-relaxed">
                Sage isn't just a chatbot; it's an AI trained on thousands of successful grow cycles. It watches your data, predicts your yields, and answers your toughest questions.
              </p>
                ...
                {[
                  {
                    ...
                    desc: "Upload a photo of your tray. Sage instantly distinguishes between harmless root hairs and dangerous mold."
                  },
                  {
                    icon: BrainCircuit,
                    title: "Predictive Yields",
                    desc: "Sage analyzes your harvest history to tell you exactly how much extra seed to sow for that big order."
                  },
                  {
                    icon: CloudSun,
                    title: "Climate Adaptation",
                    desc: "Growing in a cold garage? Sage adjusts harvest dates automatically based on your temperature logs."
                  }
                ].map((item, i) => (
                  <motion.div
                    key={i}
              ...
              <div className="relative w-full max-w-md">
                ...
                >
                  <div className="flex items-center gap-3 border-b border-white/5 pb-4 mb-4">
                    <div className="w-10 h-10 rounded-full bg-gradient-to-br from-indigo-500 to-emerald-500 flex items-center justify-center shadow-lg shadow-emerald-500/20">
                  ...
                  <div className="space-y-4">
                    <div className="flex gap-3 justify-end">
                      <div className="bg-slate-800 text-slate-200 text-sm px-4 py-2 rounded-2xl rounded-tr-sm max-w-[85%]">
                        Is this mold on my radish trays?
                        <div className="mt-2 h-24 w-32 bg-slate-700 rounded-lg flex items-center justify-center text-xs text-slate-500">
                          [IMG_0241.JPG]
                        </div>
                      </div>
                    </div>
                    ...
                    >
                      ...
                      <div className="bg-indigo-500/10 border border-indigo-500/20 text-indigo-100 text-sm px-4 py-3 rounded-2xl rounded-tl-sm max-w-[90%]">
                        <p className="mb-2">Scanning image...</p>
                        <p className="font-medium text-emerald-400">Good news! That is NOT mold.</p>
                        <p className="mt-2 text-slate-400 text-xs">Those are root hairs looking for water. Your humidity is slightly low (42%), which causes them to fuzzy up. Give them a misting!</p>
                      </div>
                    </motion.div>
                  </div>
                  ...
                  >
                    ...
                    <span className="text-xs font-bold text-slate-300">Accuracy 98.4%</span>
                  </motion.div>
      ...
      <section className="py-20 bg-slate-900/30">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <h2 className="text-3xl font-bold mb-8">Built for growers of all sizes</h2>
            <div className="space-y-4">
              {[
            ...
            <div className="bg-slate-950 border border-white/10 rounded-2xl p-8 shadow-2xl">
              <div className="flex gap-6 mb-8 border-b border-white/10 pb-8">
                <div className="text-center flex-1">
                  ...
                  <h4 className="font-bold">In The Field</h4>
                  <p className="text-xs text-slate-500 mt-1">Check off tasks, log harvests, and view recipes on your phone.</p>
                </div>
                <div className="w-px bg-white/10" />
                <div className="text-center flex-1">
                  <Monitor className="mx-auto mb-2 text-blue-400" size={32} />
                  <h4 className="font-bold">In The Office</h4>
      ...
      <section className="py-32 px-6 text-center">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-6">Ready to optimize your farm?</h2>
        ...
        <footer className="mt-24 pt-8 border-t border-white/10 text-slate-600 text-sm">
